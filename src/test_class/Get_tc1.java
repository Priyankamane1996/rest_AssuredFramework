...
import common_method.CommonMethodGetApi;
...
public class Get_tc1 {
	...
	public static void orchestrator() throws IOException {
		...
		for (int i=0; i<5; i++)
		{
			responseStatuscode = CommonMethodGetApi.responsestatus_extractor(baseuri, resource);
			if (responseStatuscode == 200)
			{
				responseBody = CommonMethodGetApi.reponsebody_extractor(baseuri, resource);
